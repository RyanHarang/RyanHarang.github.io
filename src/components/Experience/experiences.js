const experiences = [
    {
        ...
        description:
            "Working as an Associate Software Engineer at Strivve, contributing to the development of CardUpdatr, a platform that automates merchant site credit card updates. Specializing in large scale web automation.",
    },
    {
    ...
    },
    {
        ...
        description:
            "Led a collaborative effort with a non-profit, The Ladder to develop an interactive audio system run through Alexa. Used Firebase to store a graph structure that determined the flow of audio based on user utterances.",
    },
];
