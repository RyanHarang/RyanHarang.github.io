  ...
  return (
    <section id="contact" className="dark:bg-dark-850 bg-dark-200">
      <div className="flex justify-center">
        <h2 className="xl:text-6xl md:text-5xl text-3xl">Contact me</h2>
      </div>
      ...
      <div className="flex justify-center mt-8">
        <ul className="grid grid-cols-1 gap-2">
          <li>
            ...
            >
              {/* All images used to have lg:h-16 lg:w-16 h-10 w-10 */}
              <img
                src={email}
                alt="Email me"
                title="Email me"
                loading="lazy"
                className="h-16 w-16 group-hover:scale-110 transition-transform duration-500 ease-in-out"
              />
